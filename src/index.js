        ...
        return (
          <main>
            <section className="container w-100 min-vh-100 d-flex justify-content-center align-items-center">
              {users.map((user) => (
                <div className="card text-white bg-primary my-5  py-4 sm:w-50" style={{maxWidth: "600px"}} key='1' >
...
const UserName = ({ name }) => <h2 className="display-4 lead fw-bold pb-3 text-center">{name.title} {name.first} {name.last}</h2>;
